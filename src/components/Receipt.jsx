        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          >
            ...
            <div className="text-center pb-6 border-b border-dashed border-slate-200 dark:border-slate-800">
              ...
              <p className="text-xs text-slate-400 mt-1 uppercase tracking-wider">Shared Shopping Cart Session</p>
              
              <div className="mt-4 grid grid-cols-2 gap-2 text-left text-xs font-semibold text-slate-500 dark:text-slate-400">
            ...
            <div className="border-t border-dashed border-slate-200 dark:border-slate-800 py-4 flex justify-between items-center">
              <div>
                <span className="text-xs text-slate-400 uppercase tracking-wider">Total Items Count</span>
                <span className="block font-bold text-slate-800 dark:text-slate-100">{totalItemsCount} items</span>
              </div>
              <div className="text-right">
                <span className="text-xs text-slate-400 uppercase tracking-wider">Grand Total</span>
